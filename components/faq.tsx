    ...
    >
      ...
      <div className='absolute inset-0 pointer-events-none z-0'>
        ...
        <motion.div
          ...
          className='absolute top-[10%] right-[-5%] w-[40%] aspect-square bg-primary/5 blur-[120px] rounded-full'
        />
        <motion.div
          style={{
            y: useTransform(scrollYProgress, [0, 1], [50, -50]),
          }}
          className='absolute bottom-[10%] left-[-5%] w-[35%] aspect-square bg-primary/10 blur-[130px] rounded-full'
        />
      </div>
              ...
              >
                <AccordionTrigger className='group/trigger flex items-center gap-4 py-8 text-left hover:no-underline focus-visible:ring-0 after:hidden'>
                  <div className='flex flex-col items-start gap-3 w-full'>
                    <span className='font-serif text-xs tracking-[0.3em] text-primary/40 uppercase'>
                      {faq.number}
                    </span>
                ...
                <AccordionContent className='pb-10 pr-6 md:pr-12 text-lg md:text-xl leading-relaxed text-foreground/70 font-light italic'>
